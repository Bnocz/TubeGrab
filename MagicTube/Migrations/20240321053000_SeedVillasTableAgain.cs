...
{
    /// <inheritdoc />
    public partial class SeedVillasTableAgain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.", "https://dotnetmasteryimages.blob.core.windows.net/bluevillaimages/villa3.jpg", "Royal Villa", 4 });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "CreatedDate", "Details", "ImageUrl", "Name", "Occupancy" },
                values: new object[] { new DateTime(2024, 3, 20, 22, 12, 13, 140, DateTimeKind.Local).AddTicks(2588), "Lorem Ipsum Dolum Doorum", "", "testVilla", 5 });
        }
    }
}
